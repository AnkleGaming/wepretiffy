...
const SkeletonItem = () => (
  <div className="flex justify-between items-center border-b border-gray-100 pb-3 animate-pulse">
    ...
    <div className="text-right">
      <div className="h-5 bg-blue-200 rounded-full w-16 mb-1" />
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white flex flex-col">
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 bg-white shadow-md z-40 border-b border-gray-200">
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <h1 className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-red-500">
            Vendor Assignment
          </h1>
