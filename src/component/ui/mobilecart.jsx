          ...
          {hasReorder && (
            <div className="flex items-center gap-3">
              <button
                ...
                className="flex-1 text-center bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-2xl font-medium text-lg shadow-2xl active:scale-98 transition-all border border-white/30"
              >
