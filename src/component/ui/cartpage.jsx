...
const CartPage = () => {
  ...
  return (
    <>
      {/* Main Cart Container */}
      <div className="w-full max-w-md mx-auto bg-white rounded-2xl shadow-xl overflow-hidden font-sans">
        {/* Header */}
        <div className="py-5 sm:p-6 border-b border-gray-100 bg-gray-50/50">
        ...
        >
          ...
          {activeTab === "cart" &&
            ...
            orders.length === 0 &&
            !isCartLoading && (
              <div className="text-center py-12 w-[300px]">
          ...
          {(activeTab === "cart" && !hiddenCartBecauseReorder
            ...
            >
              ...
              <div className="flex flex-col items-end gap-3">
                ...
                {/* Price */}
                <p className="font-bold text-lg bg-blue-600 bg-clip-text text-transparent">
                  ₹
                  {(
