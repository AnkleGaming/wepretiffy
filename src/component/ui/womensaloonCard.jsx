...
const WomensCard = ({ icon, label, onClick }) => {
  return (
    <button
      onClick={onClick}
      className="group flex flex-col items-center space-y-3 transition-all duration-300 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-400 rounded-2xl"
    ...
    >
      <div
        className={`
          ...
          hover:shadow-2xl hover:ring-blue-300 
