        ...
        cartItems.map((item) => (
          ...
          >
            ...
            <div className="flex flex-col items-end">
              <div className="flex items-center border border-blue-200 bg-blue-50 rounded-full px-2 py-1 gap-2 text-xs font-medium hover:border-indigo-300 transition-all">
