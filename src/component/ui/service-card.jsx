    ...
    >
      ...
      <div
        className={`
          ...
          shadow-lg
          group-hover:shadow-2xl group-hover:ring-2 group-hover:ring-blue-300/50
      ...
      <span className="absolute inset-0 rounded-xl ring-0 group-active:ring-4 group-active:ring-blue-400/30 transition-all duration-200" />
    </button>
  );
};
      ...
      <div className="w-full max-w-7xl">
        ...
        >
          ...
          {loading ? (
            ...
            <div className="max-h-[300px] sm:max-h-[550px] overflow-y-auto scrollbar-thin scrollbar-thumb-blue-200 scrollbar-track-gray-50 p-1 sm:p-5">
