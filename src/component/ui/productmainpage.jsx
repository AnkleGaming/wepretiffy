      ...
      <div className="md:hidden fixed top-0 left-0 w-full bg-white shadow-lg z-50 border-b border-gray-200">
        <div className="flex items-center justify-between px-4 py-3 sm:px-6">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            onClick={goBack}
            className="p-2.5 rounded-full bg-gray-50 hover:bg-gray-100 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-400"
            aria-label="Go back"
          >
            <svg
                ...
                <>
                  ...
                  {loaded && instanceRef.current && (
                    <>
                      ...
                      >
                        <svg
                          className="w-5 h-5 text-gray-700 group-hover:text-blue-600 transition"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <div className="flex gap-4">
                    <motion.button
                      ...
                      className="px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-lg hover:from-indigo-700 hover:to-purple-700 transition-all duration-200"
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                  ...
                  <div className="flex flex-col items-center text-center">
                    ...
                    <div className="flex gap-4">
                      <motion.button
                        ...
                        className="px-6 py-3 bg-gradient-to-r from-blue-600 to-gray-600 text-white font-semibold rounded-lg hover:from-blue-700 hover:to-gray-700 transition-all duration-200 hover:cursor-pointer"
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                        aria-label="Go to cart"
                      >
