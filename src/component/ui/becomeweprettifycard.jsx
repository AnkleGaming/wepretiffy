      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="relative">
          <input
            ...
            placeholder=" "
            className={`peer w-full border ${Colors.borderGray} rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent transition-all`}
            required
          />
          <label
        ...
        <div className="relative">
          <textarea
            ...
            placeholder=" "
            rows="3"
            className={`peer w-full border ${Colors.borderGray} rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent transition-all resize-none`}
          ></textarea>
          <label
            className={`absolute left-3 -top-2.5 text-xs ${Colors.textGray} bg-white px-1 transition-all 
            peer-placeholder-shown:top-3 peer-placeholder-shown:text-gray-400 peer-placeholder-shown:text-sm
        ...
        <div className="relative">
          <select
            ...
            value={formData.type}
            onChange={handleChange}
            className={`peer w-full border ${Colors.borderGray} rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent transition-all appearance-none bg-white`}
            required
          >
        ...
        <button
          type="submit"
          disabled={loading}
          className={`w-full bg-blue-600 text-white font-semibold py-3 rounded-xl shadow-md hover:cursor-pointer hover:-translate-y-0.5 transition-all ${Colors.hoverFrom} ${Colors.hoverTo}`}
        >
