      ...
      <div>
        <div className="md:hidden flex justify-between items-center px-[25px] mt-1">
          <motion.div
            ...
            className="mt-1"
          >
            <div className="flex items-center bg-gray-50 border border-gray-300 rounded-xl px-5 py-3 shadow-sm focus-within:ring-2 focus-within:ring-blue-400 transition-all">
        ...
        <div className="mt-2 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
          {isLoading ? (
            ...
            filteredServices.map((service, index) => (
              ...
              >
                <Card
                  className="h-[340px] rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-blue-300 cursor-pointer overflow-hidden group"
