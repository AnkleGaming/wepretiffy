...
import logo from "../assets/hukmee.jpg";
                ...
                <div className="relative" ref={dropdownRef}>
                  ...
                  {open && (
                    <div className="absolute right-0 mt-3 bg-white shadow-xl rounded-xl w-56 z-50 text-sm border border-gray-100 transform transition-all duration-300 scale-95 origin-top-right animate-in">
                      <Link
                        to="/userprofile"
                        className={`block px-5 py-3 hover:bg-blue-50 hover:text-${Colors.primaryMain} transition-colors duration-200 text-gray-700 first:rounded-t-xl`}
                      >
                        My Profile
                      </Link>
                      <Link
                        to="/cartpage"
                        className={`flex justify-between block px-5 py-3 hover:bg-blue-50 hover:text-${Colors.primaryMain} transition-colors duration-200 text-gray-700 first:rounded-t-xl`}
                      >
                        <span>Cart</span>
                      ...
                      <Link
                        to="/transactions"
                        className={`flex justify-between items-center px-5 py-3 hover:bg-blue-50 hover:text-${Colors.primaryMain} transition-colors duration-200 text-gray-700 first:rounded-t-xl`}
                      >
                        <span>Wallet</span>
                        <span
                      ...
                      <button
                        onClick={handleLog}
                        className="block w-full text-left px-5 py-3 hover:bg-blue-50 hover:text-${Colors.primaryMain} transition-colors duration-200 text-red-500 last:rounded-b-xl"
                      >
                        Logout
                      </button>
                    </div>
